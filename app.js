...
var editTask=function(){
  ...
  var containsClass=listItem.classList.contains("task-list__item_edit_mode");
  //If class of the parent is .task-list__item_edit_mode
  if(containsClass){

    //switch to .task-list__item_edit_mode
  ...
  //toggle .task-list__item_edit_mode on the parent.
  listItem.classList.toggle("task-list__item_edit_mode");
};
